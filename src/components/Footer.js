const Footer = () => {
    ...
    return (
        <footer className="text-gray-50 bg-gray-900 px-4 py-5 mx-auto pt-48">
            <div className="mt-8 items-center justify-between sm:flex max-w-screen-xl mx-auto md:px-8">
                <div className="mt-4 sm:mt-0">
                    &copy; 2022 Crime Branch All rights reserved.
                </div>
